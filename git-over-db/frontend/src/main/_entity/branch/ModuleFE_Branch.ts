...
export const dispatch_onGitOverDbBranchChanged = new ThunderDispatcherV3<DispatcherType_Branch>('__onGitOverDbBranchUpdated');

export class ModuleFE_Branch_Class
...
export const ModuleFE_Branch = new ModuleFE_Branch_Class();
